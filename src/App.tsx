...
//------------------------------------------------------------------------------
const scene_id = "ae9ec718-8095-4536-ad7e-ccce82ea8318";
const token = "public_jSIh1p2k7HkFSNAc";
          ...
          <div className="flex flex-col items-center sm:items-start gap-8 sm:gap-4 py-12 sm:py-5 px-6 bg-black/70 text-white rounded-md backdrop-blur-xl shadow-xl">
            ...
            <ol className="list-inside list-decimal flex flex-col gap-1 text-md/6 text-center sm:text-left tracking-wide">
              <li>
                ...
                <code className="text-sm ml-1 text-white/60">src/App.tsx</code>
              </li>
              <li>
                <a
                  href="https://docs.3dverse.com/references/livelink.react"
                  target="_blank"
            ...
            <div className="flex gap-2">
              <a
                href="https://discord.com/invite/Ax53gQS3Pu"
                target="_blank"
                className="text-sm text-white/60 hover:text-yellow-400"
              >
                Discord
              </a>
              <a
